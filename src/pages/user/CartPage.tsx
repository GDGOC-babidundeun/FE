...
export const CartPage: React.FC = () => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-gray-50/50 pb-[90px]">
      {/* 상단 장바구니 제어 */}
      ...
      {/* 하단 결제액 요약 및 버튼 고정 */}
      <div className="absolute bottom-4 left-4 right-4 bg-white border border-gray-100 shadow-xl rounded-2xl p-4 space-y-4 z-40">
